...
public class MultipleBluetoothController {
    ...
    private final BleLruHashMap<String, BleBluetooth> bleLruHashMap;  //已線線的裝置
    private final HashMap<String, BleBluetooth> bleTempHashMap;       //正在連接的裝置
    ...
    public synchronized BleBluetooth buildConnectingBle(BleDevice bleDevice) {
        ...
        //getDeviceKey() = mDevice.getName() + mDevice.getAddress();
