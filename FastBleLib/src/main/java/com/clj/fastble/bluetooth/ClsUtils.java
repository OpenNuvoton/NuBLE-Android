...
public class ClsUtils {
    ...
    // BOND_BONDED = 12, BOND_BONDING = 11, public static final int BOND_NONE = 10;
    static public int getBondState(Class btClass, BluetoothDevice btDevice) throws Exception {
        Method createBondMethod = btClass.getMethod("getBondState");
        int returnValue = (int) createBondMethod.invoke(btDevice);
        return returnValue;
    }
